 ...
 */
qx.Class.define("mvc.patterns.command.MacroCommand", {
    ...
    members: {
         ...
         */
        _initializeMacroCommand:function() {
         ...
         * order.</P>
         *
         * @param commandClassRef {Class} a reference to the <code>Class</code> of the <code>ICommand</code>.
         */
        _addSubCommand:function(commandClassRef) {
            this.__subCommands.push(commandClassRef);
        },
         ...
         * order.
         *
         * @param notification {mvc.interfaces.INotification} the <code>INotification</code> object to be passsed to each <i>SubCommand</i>.
         */
        execute:function( notification ) {
            while ( this.__subCommands.length > 0) {
                var commandClassRef = this.__subCommands.shift();
    ...
    destruct: function () {
        this.disposeArray("__subCommands");
    }
});